...
```{r}
names(Table_S2_Egge_et_al_2015_jeukmic)[1] <- 'OTU_id'
OTU_month_nested <- MEC_14_1145_OTUtab_piconanopool_subsamp5553_correctversion %>%
  select(-Rownames)%>%
...
names(OTU_month_nested)[2] <- 'month_count'
OTU_month_nested
```
